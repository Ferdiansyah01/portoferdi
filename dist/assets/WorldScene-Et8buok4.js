import{P as p}from"./phaser-DGZayPUC.js";import{PLAYER_SPEED as P,INTERACT_RADIUS as $,SCENE_KEYS as v,PLAYER_SPAWN as M,TILE_SIZE as c,ZOOM as L,MAP_WIDTH as x,MAP_HEIGHT as _,TILESET_KEY as A,TILES as k,ZONES as l,OBJECT_TYPES as E}from"./gameConfig-D5w6vaLC.js";import{p as j,s as J,A as w}from"./AudioManager-CmC_a3V4.js";import{c as N,v as R,a as B,s as T,b as U,p as z}from"./index-C_-2Pg1M.js";class F extends Phaser.Physics.Arcade.Sprite{constructor(e,t,s,i){super(e,t,s,"player"),this.scene=e,this._inputCtrl=i,e.add.existing(this),e.physics.add.existing(this),this.setCollideWorldBounds(!0),this.body.setSize(10,10),this.body.setOffset(3,6),this.setDepth(10),this._facing="down",this._isMoving=!1,this._isJumping=!1,this._dustTimer=0,this._createAnimations(),this._createShadow(),this._createIdleBob()}_createShadow(){this._shadow=this.scene.add.ellipse(this.x,this.y+7,12,5,0,.28).setDepth(9)}_createIdleBob(){this._bobTween=this.scene.tweens.add({targets:this,scaleY:1.02,scaleX:.985,duration:900,yoyo:!0,repeat:-1,ease:"Sine.easeInOut",paused:!0})}_spawnDust(){const e=this.scene.add.circle(this.x+Phaser.Math.Between(-4,4),this.y+6,1.5,16777215,.28).setDepth(8);this.scene.tweens.add({targets:e,y:e.y-4,alpha:0,scale:2.2,duration:420,ease:"Sine.easeOut",onComplete:()=>e.destroy()})}jump(){if(this._isJumping)return;this._isJumping=!0,this._bobTween&&!this._bobTween.paused&&(this._bobTween.pause(),this.setScale(1));const e=this.y;this.scene.tweens.add({targets:this,y:e-14,duration:160,ease:"Quad.easeOut",yoyo:!0,onComplete:()=>{this.y=e,this._isJumping=!1,this._spawnDust(),this.scene.tweens.add({targets:this,scaleY:.88,scaleX:1.12,duration:80,yoyo:!0,ease:"Quad.easeOut",onComplete:()=>this.setScale(1)}),this.scene.tweens.add({targets:this._shadow,scaleX:1.35,scaleY:.6,alpha:.18,duration:80,yoyo:!0,ease:"Quad.easeOut"})}}),this.scene.tweens.add({targets:this._shadow,scaleX:.72,scaleY:.72,alpha:.16,duration:160,ease:"Quad.easeOut"});try{this.scene.sound.play("sfx_interact",{volume:.35})}catch{}}get isJumping(){return this._isJumping}_createAnimations(){const e=this.scene.anims;if(e.exists("walk-down"))return;[{key:"walk-down",start:0},{key:"walk-left",start:3},{key:"walk-right",start:6},{key:"walk-up",start:9}].forEach(({key:s,start:i})=>{e.create({key:s,frames:e.generateFrameNumbers("player",{frames:[i,i+1,i+2]}),frameRate:8,repeat:-1}),e.create({key:s.replace("walk","idle"),frames:e.generateFrameNumbers("player",{frames:[i]}),frameRate:4,repeat:-1})})}update(){this._shadow&&(this._shadow.setPosition(this.x,this.y+7),this._shadow.setAlpha(this._isMoving?.22:.28),this._shadow.setScale(this._isMoving?1.1:1));const e=this._inputCtrl.getDirection(),t=e.x!==0||e.y!==0;if(t){const i=Math.sqrt(e.x*e.x+e.y*e.y);this.setVelocity(e.x/i*P,e.y/i*P),e.y>0?this._facing="down":e.y<0?this._facing="up":e.x<0?this._facing="left":e.x>0&&(this._facing="right")}else this.setVelocity(0,0);t?(this._dustTimer+=this.scene.game.loop.delta,this._dustTimer>110&&(this._dustTimer=0,this._spawnDust()),this._bobTween?.isPaused?.()===!1&&(this._bobTween.pause(),this.setScale(1))):this._bobTween?.isPaused?.()&&this._bobTween.resume();const s=t?`walk-${this._facing}`:`idle-${this._facing}`;this.anims.currentAnim?.key!==s&&this.play(s),this._isMoving=t}destroy(e){this._shadow?.destroy(),this._bobTween?.remove(),super.destroy(e)}get facing(){return this._facing}get isMoving(){return this._isMoving}}class I{constructor(e,t,s,{id:i,type:o,label:n,data:r}){this.scene=e,this.x=t,this.y=s,this.id=i,this.type=o,this.label=n,this.data=r,this._active=!1,this._gfx=null,this._pulseTimer=null,this._createVisual()}_createVisual(){const t={project:440020,skills:1096065,about:8141549,contact:16096779,exit:16096779}[this.type]||8141549,s=this.scene.add.ellipse(this.x,this.y+10,14,6,0,.22).setDepth(4),i=this.scene.add.circle(this.x,this.y,14,t,0).setDepth(5).setStrokeStyle(1.5,t,.5),o=this.scene.add.circle(this.x,this.y,12,t,.22).setDepth(5).setBlendMode(Phaser.BlendModes.ADD),n={project:"🖥️",skills:"📚",about:"👤",contact:"📬",exit:"🚪"},r=this.scene.add.text(this.x,this.y,n[this.type]||"❓",{fontSize:"16px",resolution:2}).setOrigin(.5).setDepth(6);this.scene.tweens.add({targets:r,y:this.y-4,duration:1200+Math.random()*500,yoyo:!0,repeat:-1,ease:"Sine.easeInOut"}),this.scene.tweens.add({targets:o,alpha:{from:.22,to:.48},scale:{from:1,to:1.35},duration:900+Math.random()*300,yoyo:!0,repeat:-1,ease:"Sine.easeInOut"}),this.scene.tweens.add({targets:i,scale:{from:1,to:1.45},alpha:{from:.5,to:0},duration:1400,repeat:-1,ease:"Sine.easeInOut"});const a=[];for(let d=0;d<2;d++){const h=this.scene.add.circle(this.x+Phaser.Math.Between(-8,8),this.y+Phaser.Math.Between(-8,8),1,16777215,.85).setDepth(7).setBlendMode(Phaser.BlendModes.ADD);this.scene.tweens.add({targets:h,y:h.y-10,alpha:0,scale:1.8,duration:1300+d*400,repeat:-1,delay:d*600+Math.random()*800,ease:"Sine.easeInOut"}),a.push(h)}this._shadow=s,this._ring=i,this._glow=o,this._icon=r,this._sparkles=a,this._color=t}setActive(e){this._active!==e&&(this._active=e,this.scene.tweens.add({targets:[this._glow,this._ring],alpha:e?.85:.22,scale:e?1.25:1,duration:220,ease:"Back.easeOut"}),this.scene.tweens.add({targets:this._icon,scale:e?1.18:1,duration:200,ease:"Back.easeOut"}),this.scene.tweens.add({targets:this._shadow,alpha:e?.35:.22,scaleX:e?1.2:1,duration:200}),e&&(this._sparkles.forEach(t=>{t.setPosition(this.x+Phaser.Math.Between(-6,6),this.y),t.setAlpha(1).setScale(.2),this.scene.tweens.add({targets:t,y:t.y-14,alpha:0,scale:2,duration:500,ease:"Sine.easeOut"})}),this.scene.cameras.main.shake(80,.002)))}get isActive(){return this._active}destroy(){this._shadow?.destroy(),this._ring?.destroy(),this._glow?.destroy(),this._icon?.destroy(),this._sparkles?.forEach(e=>e.destroy())}}class Y{constructor(e){this.scene=e,this._cursors=e.input.keyboard.createCursorKeys(),this._wasd=e.input.keyboard.addKeys({up:Phaser.Input.Keyboard.KeyCodes.W,down:Phaser.Input.Keyboard.KeyCodes.S,left:Phaser.Input.Keyboard.KeyCodes.A,right:Phaser.Input.Keyboard.KeyCodes.D}),this._actionKey=e.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.E),this._jumpKey=e.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.SPACE),this._spaceKey=this._jumpKey,this._escKey=e.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.ESC),this._prevJumpState=!1,this._vDir={up:!1,down:!1,left:!1,right:!1},this._vAction=!1,this._actionConsumed=!1,this._prevActionState=!1,this._isTouchDevice="ontouchstart"in window||navigator.maxTouchPoints>0,this._isTouchDevice&&this._buildVirtualDPad()}_buildVirtualDPad(){const e=document.createElement("div");e.id="virtual-dpad",e.innerHTML=`
    ...
    `,document.body.appendChild(s),this._jumpBtn=s,["up","down","left","right"].forEach(o=>{const n=document.getElementById(`dpad-${o}`);if(!n)return;const r=a=>{this._vDir[o]=a};n.addEventListener("touchstart",a=>{a.preventDefault(),r(!0)}),n.addEventListener("touchend",a=>{a.preventDefault(),r(!1)}),n.addEventListener("mousedown",()=>r(!0)),n.addEventListener("mouseup",()=>r(!1)),n.addEventListener("mouseleave",()=>r(!1))}),t.addEventListener("touchstart",o=>{o.preventDefault(),this._vAction=!0}),t.addEventListener("touchend",o=>{o.preventDefault(),this._vAction=!1}),t.addEventListener("mousedown",()=>{this._vAction=!0}),t.addEventListener("mouseup",()=>{this._vAction=!1}),this._vJump=!1,s.addEventListener("touchstart",o=>{o.preventDefault(),this._vJump=!0}),s.addEventListener("touchend",o=>{o.preventDefault(),this._vJump=!1}),s.addEventListener("mousedown",()=>{this._vJump=!0}),s.addEventListener("mouseup",()=>{this._vJump=!1}),s.addEventListener("mouseleave",()=>{this._vJump=!1})}_isTyping(){const e=document.activeElement;return e&&(e.tagName==="INPUT"||e.tagName==="TEXTAREA"||e.isContentEditable)}getDirection(){if(this._isTyping())return{x:0,y:0};const e=this._cursors.up.isDown||this._wasd.up.isDown||this._vDir.up,t=this._cursors.down.isDown||this._wasd.down.isDown||this._vDir.down,s=this._cursors.left.isDown||this._wasd.left.isDown||this._vDir.left;return{x:(this._cursors.right.isDown||this._wasd.right.isDown||this._vDir.right?1:0)-(s?1:0),y:(t?1:0)-(e?1:0)}}isActionJustPressed(){if(this._isTyping())return!1;const e=Phaser.Input.Keyboard.JustDown(this._actionKey)||this._vAction;return e&&!this._prevActionState?(this._prevActionState=!0,!0):(e||(this._prevActionState=!1),!1)}isJumpJustPressed(){if(this._isTyping())return!1;const e=Phaser.Input.Keyboard.JustDown(this._jumpKey)||this._vJump;return e&&!this._prevJumpState?(this._prevJumpState=!0,!0):(e||(this._prevJumpState=!1),!1)}isEscapeJustPressed(){return Phaser.Input.Keyboard.JustDown(this._escKey)}destroy(){document.getElementById("virtual-dpad")?.remove(),document.getElementById("btn-action")?.remove(),document.getElementById("btn-jump")?.remove()}}class H{constructor(e,t){this.scene=e,this.player=t,this._objects=[],this._nearest=null,this._eventEmitter=new Phaser.Events.EventEmitter}register(e){this._objects.push(e)}update(){if(!this.player||!this.player.active)return;const e=this.player.x,t=this.player.y;let s=1/0,i=null;for(const o of this._objects){const n=o.x-e,r=o.y-t,a=Math.sqrt(n*n+r*r);a<=$&&a<s&&(s=a,i=o)}i!==this._nearest&&(this._nearest&&(this._nearest.setActive(!1),this._eventEmitter.emit("proximity-exit",this._nearest)),i&&(i.setActive(!0),this._eventEmitter.emit("proximity-enter",i)),this._nearest=i)}get nearestObject(){return this._nearest}on(e,t,s){return this._eventEmitter.on(e,t,s),this}off(e,t,s){return this._eventEmitter.off(e,t,s),this}}class b{static KEYS={POSITION:"devquest_pos",MUTED:"devquest_muted",NAME:"devquest_name"};static savePosition(e,t){localStorage.setItem(b.KEYS.POSITION,JSON.stringify({x:e,y:t}))}static loadPosition(){try{const e=localStorage.getItem(b.KEYS.POSITION);return e?JSON.parse(e):null}catch{return null}}static saveMutePreference(e){localStorage.setItem(b.KEYS.MUTED,e?"true":"false")}static loadMutePreference(){return localStorage.getItem(b.KEYS.MUTED)==="true"}static saveName(e){localStorage.setItem(b.KEYS.NAME,e)}static loadName(){return localStorage.getItem(b.KEYS.NAME)||"Guest"}static clearAll(){Object.values(b.KEYS).forEach(e=>localStorage.removeItem(e))}}class D{constructor(e){this.data=e,this._el=null,this._onClose=null}open(e){this._onClose=e;const t=document.createElement("div");t.className="modal-backdrop",t.id="active-modal-backdrop",t.innerHTML=`
    ...
    `}}class W extends D{_renderContent(e){const t=e.techStack.map(o=>`<span class="tech-chip">${o}</span>`).join(""),s=e.githubUrl?`<a href="${e.githubUrl}" target="_blank" rel="noopener" class="modal-action-btn modal-btn-github">
    ...
    `}}class X extends D{_renderContent(e){const t=i=>{const n={advanced:3,intermediate:2,beginner:1}[i]??1;return Array(3).fill(0).map((r,a)=>`<span style="width:6px;height:6px;border-radius:50%;display:inline-block;background:${a<n?"currentColor":"rgba(148,163,184,0.25)"};"></span>`).join("")},s=e.map(i=>`
    ...
    `}}class Z extends D{_renderContent(e){const t=e.socials?.map(i=>{const o={github:"🐙",linkedin:"💼",twitter:"🐦",instagram:"📸"};return`
    ...
    `}open(e){super.open(e),this._bindContactEvents()}_bindContactEvents(){const e=a=>{a&&["keydown","keyup","keypress"].forEach(d=>a.addEventListener(d,h=>h.stopPropagation()))};e(document.getElementById("contact-name")),e(document.getElementById("contact-email-field")),e(document.getElementById("contact-msg"));const t=document.getElementById("copy-email-btn");t&&this.data.email&&t.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(this.data.email),t.textContent="✅ Copied!",t.style.background="rgba(16,185,129,0.2)",t.style.borderColor="rgba(16,185,129,0.5)",t.style.color="#34d399",this._showToast("Email copied to clipboard! 📋"),setTimeout(()=>{t.innerHTML="📋 Copy Email",t.style.background="rgba(251,191,36,0.15)",t.style.borderColor="rgba(251,191,36,0.35)",t.style.color="#fbbf24"},2e3)}catch{const a=document.createElement("textarea");a.value=this.data.email,document.body.appendChild(a),a.select(),document.execCommand("copy"),a.remove(),this._showToast("Email copied! 📋")}});const s=document.getElementById("contact-send-btn"),i=document.getElementById("contact-send-label"),o=document.getElementById("contact-status"),n=document.getElementById("contact-msg"),r=document.getElementById("contact-char-count");n&&r&&n.addEventListener("input",()=>{r.textContent=`${n.value.length} / 500`,r.style.color=n.value.length>450?"#f59e0b":"#475569"}),s&&s.addEventListener("click",async()=>{const a=document.getElementById("contact-name")?.value||"",d=document.getElementById("contact-email-field")?.value||"",h=document.getElementById("contact-msg")?.value||"";N(["contact-name","contact-email-field","contact-msg"]);const{valid:f,errors:y}=R({name:a,email:d,message:h});if(!f){y.name&&B(document.getElementById("contact-name"),y.name),y.email&&B(document.getElementById("contact-email-field"),y.email),y.message&&B(n,y.message),T(y.name||y.email||y.message,"#ef4444");return}s.disabled=!0,s.style.opacity="0.7",s.style.cursor="not-allowed",i&&(i.textContent="Sending... ⏳"),o&&(o.textContent="Sending...");const m=await U({name:a,email:d,message:h});s.disabled=!1,s.style.opacity="1",s.style.cursor="pointer",m.ok?(m.via==="ajax"?(T("Message sent! I'll reply soon ✨","#10b981"),o&&(o.textContent="✅ Sent! Check dianferdi01@gmail.com",o.style.color="#10b981")):m.via==="mailto"&&(T("Opening email app — message ready to send ✉️","#0ea5e9"),o&&(o.textContent="📧 Email app opened",o.style.color="#0ea5e9")),document.getElementById("contact-name").value="",document.getElementById("contact-email-field").value="",n.value="",r&&(r.textContent="0 / 500"),i&&(i.textContent="Sent! ✅"),setTimeout(()=>{i&&(i.textContent="Send Message 🚀"),o&&(o.textContent="")},3e3)):(T("Failed, but saved locally. Try again ✨","#f59e0b"),o&&(o.textContent="⚠️ Saved locally",o.style.color="#f59e0b"),i&&(i.textContent="Send Message 🚀"))})}_showToast(e,t="#10b981"){T(e,t)}}class te extends p.Scene{constructor(){super({key:v.WORLD}),this._player=null,this._inputController=null,this._proximityMgr=null,this._modalOpen=!1,this._exiting=!1,this._activeModal=null,this._exitObject=null}create(){this.registry.get("playerName");const e=this.registry.get("muted")||b.loadMutePreference();this._buildTilemap();const t=b.loadPosition(),s=t?.x??M.x*c,i=t?.y??M.y*c;this._inputController=new Y(this),this._player=new F(this,s,i,this._inputController),this.physics.add.collider(this._player,this._collisionLayer);const n=window.innerWidth<768||/Mobile|Android|iPhone/i.test(navigator.userAgent)?2:L;this.cameras.main.setZoom(n),this.cameras.main.startFollow(this._player,!0,.12,.12),this.cameras.main.setBounds(0,0,x*c,_*c),this._interactiveObjects=[],this._spawnInteractiveObjects(),this._proximityMgr=new H(this,this._player),this._interactiveObjects.forEach(r=>this._proximityMgr.register(r)),this._proximityMgr.on("proximity-enter",r=>{this.scene.get(v.UI)?.showIndicator(r,this.cameras.main)},this),this._proximityMgr.on("proximity-exit",()=>{this.scene.get(v.UI)?.hideIndicator()},this),this._setupAudio(e),this.input.keyboard.on("keydown-ESC",()=>{this._modalOpen?this._closeModal():this._exiting||this._exitToMenu()}),this.events.once("shutdown",()=>{!this._exiting&&this._player&&b.savePosition(this._player.x,this._player.y),this._inputController?.destroy(),this._inputController=null,this._interactiveObjects?.forEach(r=>{try{r.destroy()}catch{}}),this._interactiveObjects=[],this._exitObject=null,this._proximityMgr?.removeAllListeners?.();try{this.scene.get(v.UI)?.hideIndicator?.()}catch{}try{this.tweens.killAll()}catch{}try{this.time.removeAllEvents()}catch{}this._modalOpen=!1,this._exiting=!1,window.__worldExitFallback&&(clearTimeout(window.__worldExitFallback),window.__worldExitFallback=null)}),this._drawZoneLabels(),this._createAtmosphere(),this._createAmbientParticles(),this._createZoneDecorations(),this._createFloatingProps(),this._checkDeviceCapability()}_buildTilemap(){const e=this._generateMapData(),t=this.make.tilemap({data:e,tileWidth:c,tileHeight:c}),s=t.addTilesetImage(A,A,c,c);this._groundLayer=t.createLayer(0,s,0,0),this._groundLayer.setDepth(0);const i=this._generateWallData(),o=this.make.tilemap({data:i,tileWidth:c,tileHeight:c}),n=o.addTilesetImage(A,A,c,c);this._collisionLayer=o.createLayer(0,n,0,0),this._collisionLayer.setDepth(1),this._collisionLayer.setCollisionByExclusion([-1]),this.physics.world.setBounds(0,0,x*c,_*c)}_generateMapData(){const{FLOOR_WOOD:e,FLOOR_TILE:t,FLOOR_CARPET:s,FLOOR_DARK:i,PATH:o}=k,n=[];for(let r=0;r<_;r++){const a=[];for(let d=0;d<x;d++)this._inZone(d,r,l.ABOUT)?a.push(s):this._inZone(d,r,l.PROJECTS)?a.push(i):this._inZone(d,r,l.SKILLS)?a.push(e):this._inZone(d,r,l.CONTACT)?a.push(t):a.push(o);n.push(a)}return n}_generateWallData(){const{WALL_TOP:e,WALL_SIDE:t,WALL_CORNER:s}=k,i=Array.from({length:_},()=>Array(x).fill(-1)),o=a=>{const{x:d,y:h,w:f,h:y}=a;for(let u=d;u<d+f;u++)i[h][u]=e,i[h+y-1][u]=e;for(let u=h;u<h+y;u++)i[u][d]=t,i[u][d+f-1]=t;i[h][d]=s,i[h][d+f-1]=s,i[h+y-1][d]=s,i[h+y-1][d+f-1]=s;const m=Math.floor(d+f/2)-1,g=h>10?h:h+y-1;for(let u=0;u<3;u++)i[g][m+u]=-1};for(let a=0;a<x;a++)i[0][a]=k.WALL_TOP,i[_-1][a]=k.WALL_TOP;for(let a=0;a<_;a++)i[a][0]=k.WALL_SIDE,i[a][x-1]=k.WALL_SIDE;Object.values(l).forEach(o);const n=Math.floor(x/2)-1,r=_-1;for(let a=0;a<3;a++)i[r][n+a]=-1;return i}_inZone(e,t,s){return e>=s.x&&e<s.x+s.w&&t>=s.y&&t<s.y+s.h}_spawnInteractiveObjects(){const e=a=>(a+.5)*c,t=a=>(a+.5)*c,s=new I(this,e(l.ABOUT.x+5),t(l.ABOUT.y+5),{id:"about_board",type:E.ABOUT,label:"About Me",data:z});this._interactiveObjects.push(s),j.forEach((a,d)=>{const h=d%3,f=Math.floor(d/3),y=new I(this,e(l.PROJECTS.x+4+h*6),t(l.PROJECTS.y+4+f*6),{id:a.mapObjectId,type:E.PROJECT,label:a.title,data:a});this._interactiveObjects.push(y)});const i=new I(this,e(l.SKILLS.x+5),t(l.SKILLS.y+5),{id:"skills_shelf",type:E.SKILLS,label:"Skills",data:J});this._interactiveObjects.push(i);const o=new I(this,e(l.CONTACT.x+5),t(l.CONTACT.y+5),{id:"contact_desk",type:E.CONTACT,label:"Contact",data:z});this._interactiveObjects.push(o);const n=Math.floor(x/2),r=new I(this,e(n),t(_-2),{id:"exit_door",type:E.EXIT,label:"🚪 Exit — Walk in or press E",data:{title:"Exit"}});this._interactiveObjects.push(r),this._exitObject=r}_drawZoneLabels(){const e=[{zone:l.ABOUT,label:"[ ABOUT ME ]",color:"#a78bfa"},{zone:l.PROJECTS,label:"[ PROJECTS ]",color:"#22d3ee"},{zone:l.SKILLS,label:"[ SKILLS ]",color:"#34d399"},{zone:l.CONTACT,label:"[ CONTACT ]",color:"#fbbf24"}],t=Math.floor(x/2)*c,s=(_-1.5)*c;this.add.rectangle(t,s+6,42,14,986906,.85).setDepth(7).setStrokeStyle(1,16096779,.6),this.add.text(t,s+6,"EXIT",{fontFamily:"'Press Start 2P', monospace",fontSize:"5px",color:"#fbbf24"}).setOrigin(.5).setDepth(8);const i=this.add.text(t,s+18,"▼",{fontFamily:"monospace",fontSize:"8px",color:"#fbbf24"}).setOrigin(.5).setDepth(8);this.tweens.add({targets:i,y:s+21,alpha:.4,duration:700,yoyo:!0,repeat:-1,ease:"Sine.easeInOut"}),e.forEach(({zone:o,label:n,color:r})=>{const a=(o.x+o.w/2)*c,d=(o.y+2)*c;this.add.text(a,d,n,{fontFamily:"'Press Start 2P', monospace",fontSize:"5px",color:r,stroke:"#000000",strokeThickness:2,alpha:.75}).setOrigin(.5).setDepth(8)})}_createAtmosphere(){const e=x*c,t=_*c,s=window.innerWidth<768,i=this.add.graphics().setScrollFactor(0).setDepth(100).setAlpha(s?.2:.35);if(i.fillGradientStyle(986906,986906,0,0,.45),i.fillRect(-400,-300,e+800,180),i.fillGradientStyle(0,0,986906,986906,.45),i.fillRect(-400,t-100,e+800,180),!s)for(let n=0;n<t;n+=6)this.add.rectangle(e/2,n,e,1,16777215,.015).setDepth(99);[{x:l.ABOUT.x+10,y:l.ABOUT.y+8,color:8141549,alpha:.08},{x:l.PROJECTS.x+11,y:l.PROJECTS.y+8,color:440020,alpha:.07},{x:l.SKILLS.x+10,y:l.SKILLS.y+8,color:1096065,alpha:.07},{x:l.CONTACT.x+11,y:l.CONTACT.y+8,color:16096779,alpha:.07}].forEach(n=>{const r=this.add.circle(n.x*c,n.y*c,90,n.color,n.alpha).setDepth(2).setBlendMode(p.BlendModes.ADD);s||this.tweens.add({targets:r,alpha:n.alpha*1.6,scale:1.08,duration:2500+Math.random()*1e3,yoyo:!0,repeat:-1,ease:"Sine.easeInOut"})}),s||this.tweens.add({targets:this.cameras.main,zoom:L*1.03,duration:4e3,yoyo:!0,repeat:-1,ease:"Sine.easeInOut"})}_createAmbientParticles(){const e=x*c,t=_*c,s=window.innerWidth<768,i=s?8:22;for(let n=0;n<i;n++){const r=p.Math.Between(10,e-10),a=p.Math.Between(10,t-10),d=this.add.circle(r,a,p.Math.FloatBetween(1,2.2),16498468,p.Math.FloatBetween(.3,.7)).setDepth(7).setBlendMode(p.BlendModes.ADD);this.tweens.add({targets:d,x:r+p.Math.Between(-60,60),y:a+p.Math.Between(-40,40),alpha:.05,duration:p.Math.Between(4e3,8e3),yoyo:!0,repeat:-1,ease:"Sine.easeInOut",delay:n*120}),s||this.tweens.add({targets:d,scale:1.6,duration:1200,yoyo:!0,repeat:-1,ease:"Sine.easeInOut"})}s||["</>","{ }","01","=>","npm","git","vue","php","< />"].forEach((r,a)=>{const d=p.Math.Between(20,e-20),h=p.Math.Between(20,t-20),f=this.add.text(d,h,r,{fontFamily:"'Press Start 2P', monospace",fontSize:"5px",color:"#2a2a4a"}).setOrigin(.5).setDepth(3).setAlpha(.35);this.tweens.add({targets:f,y:h-16,alpha:.12,duration:3e3+a*250,yoyo:!0,repeat:-1,ease:"Sine.easeInOut",delay:a*200}),this.tweens.add({targets:f,angle:p.Math.Between(-8,8),duration:2e3+a*300,yoyo:!0,repeat:-1,ease:"Sine.easeInOut"})});const o=s?5:12;for(let n=0;n<o;n++){const r=p.Math.Between(l.PROJECTS.x*c+10,(l.PROJECTS.x+l.PROJECTS.w)*c-10),a=p.Math.Between(l.PROJECTS.y*c+20,(l.PROJECTS.y+l.PROJECTS.h)*c-20),d=this.add.circle(r,a,.8,16777215,.9).setDepth(4);this.tweens.add({targets:d,alpha:.08,duration:900+n*80,yoyo:!0,repeat:-1,ease:"Sine.easeInOut",delay:n*150})}}_createZoneDecorations(){const e=m=>m*c,t=m=>m*c,s=(l.ABOUT.x+l.ABOUT.w/2)*c;(l.ABOUT.y+l.ABOUT.h/2)*c,["🌿","🪴","🌱"].forEach((m,g)=>{const u=s+(g-1)*28,C=t(l.ABOUT.y+l.ABOUT.h-3),O=this.add.text(u,C,m,{fontSize:"14px"}).setOrigin(.5).setDepth(6);this.tweens.add({targets:O,angle:4,duration:1600+g*200,yoyo:!0,repeat:-1,ease:"Sine.easeInOut"}),this.tweens.add({targets:O,y:C-2,duration:1800+g*200,yoyo:!0,repeat:-1,ease:"Sine.easeInOut",delay:g*300})});const i=this.add.circle(e(l.ABOUT.x+3),t(l.ABOUT.y+3),14,16498468,.18).setDepth(5).setBlendMode(p.BlendModes.ADD);this.tweens.add({targets:i,alpha:.32,scale:1.2,duration:1100,yoyo:!0,repeat:-1,ease:"Sine.easeInOut"});for(let m=0;m<3;m++){const g=e(l.PROJECTS.x+5+m*6),u=t(l.PROJECTS.y+4),C=this.add.rectangle(g,u,16,10,988970).setDepth(5).setStrokeStyle(1,440020,.6),O=this.add.rectangle(g,u,12,6,440020,.35).setDepth(6).setBlendMode(p.BlendModes.ADD);this.tweens.add({targets:O,alpha:.08,duration:400+m*150,yoyo:!0,repeat:-1,ease:"Stepped",delay:m*200}),this.tweens.add({targets:C,y:u-1,duration:2e3+m*400,yoyo:!0,repeat:-1,ease:"Sine.easeInOut"})}["📘","📗","📙"].forEach((m,g)=>{const u=e(l.SKILLS.x+6+g*4),C=t(l.SKILLS.y+5),O=this.add.text(u,C,m,{fontSize:"12px"}).setOrigin(.5).setDepth(6);this.tweens.add({targets:O,y:C-4,duration:1700+g*250,yoyo:!0,repeat:-1,ease:"Sine.easeInOut",delay:g*250});const K=this.add.circle(u+6,C-4,1,3462041,.9).setDepth(7).setBlendMode(p.BlendModes.ADD);this.tweens.add({targets:K,alpha:0,scale:2,duration:1400,repeat:-1,delay:g*600,ease:"Sine.easeInOut"})});const o=e(l.CONTACT.x+l.CONTACT.w/2),n=t(l.CONTACT.y+6),r=this.add.text(o,n,"✉️",{fontSize:"18px"}).setOrigin(.5).setDepth(6);this.tweens.add({targets:r,y:n-5,duration:1600,yoyo:!0,repeat:-1,ease:"Sine.easeInOut"}),this.tweens.add({targets:r,angle:5,duration:2e3,yoyo:!0,repeat:-1,ease:"Sine.easeInOut"});const a=this.add.text(o+18,n-6,"💌",{fontSize:"10px"}).setOrigin(.5).setDepth(7);this.tweens.add({targets:a,y:n-14,alpha:.2,duration:1800,yoyo:!0,repeat:-1,ease:"Sine.easeInOut",delay:600});const d=Math.floor(x/2)*c,h=(_-1)*c+8;this.add.rectangle(d-10,h-4,4,16,7877903).setDepth(5),this.add.rectangle(d+10,h-4,4,16,7877903).setDepth(5),this.add.rectangle(d,h-12,24,4,9584654).setDepth(5);const f=this.add.rectangle(d,h-2,14,12,16096779,.28).setDepth(6).setBlendMode(p.BlendModes.ADD);this.tweens.add({targets:f,alpha:.12,duration:800,yoyo:!0,repeat:-1,ease:"Sine.easeInOut"});const y=this.add.text(d,h-2,"🚪",{fontSize:"10px"}).setOrigin(.5).setDepth(7);this.tweens.add({targets:y,y:h-4,duration:1200,yoyo:!0,repeat:-1,ease:"Sine.easeInOut"})}_createFloatingProps(){const e=x*c;for(let t=0;t<4;t++){const s=p.Math.Between(30,120),i=this.add.rectangle(p.Math.Between(-80,e),s,p.Math.Between(80,140),12,16777215,.06).setDepth(8).setScrollFactor(.3);this.tweens.add({targets:i,x:e+100,duration:25e3+t*5e3,repeat:-1,ease:"Linear",delay:t*3e3})}for(let t=0;t<6;t++){const s=p.Math.Between(8,e-8),i=p.Math.Between(8,_*c-8),o=this.add.circle(s,i,10,16777215,.025).setDepth(2).setBlendMode(p.BlendModes.ADD);this.tweens.add({targets:o,alpha:.06,duration:3e3+t*400,yoyo:!0,repeat:-1,ease:"Sine.easeInOut"})}}_setupAudio(e){this._muted=e,w.init(this),w.setMuted(e),w.playBGM(this,"bgm_world",{volume:.3}),this._bgm=w._bgm}toggleMute(){const e=w.toggle();return this._muted=e,b.saveMutePreference(e),this._bgm=w._bgm,e}update(){if(!(this._modalOpen||this._exiting)&&!(!this._player||!this._proximityMgr||!this._inputController)){if(this._player.update(),this._proximityMgr.update(),this._inputController.isJumpJustPressed()&&this._player.jump(),this._exitObject&&this._player){const e=this._player.x-this._exitObject.x,t=this._player.y-this._exitObject.y;if(Math.hypot(e,t)<26){this._exitToMenu();return}}if(this._inputController.isActionJustPressed()){const e=this._proximityMgr.nearestObject;e&&(w.playSFX(this,"sfx_interact",{volume:.6}),this._openModal(e))}this.game.getFrame()%300===0&&b.savePosition(this._player.x,this._player.y)}}_exitToMenu(){if(!this._exiting&&!this._modalOpen){this._exiting=!0,window.__worldExitFallback&&(clearTimeout(window.__worldExitFallback),window.__worldExitFallback=null);try{w.playSFX(this,"sfx_close",{volume:.6})}catch{}b.savePosition(M.x*c,M.y*c),w.stopAllImmediate();try{this.sound.stopAll()}catch{}try{this.tweens.killAll()}catch{}try{this.cameras.main.stopFollow()}catch{}document.getElementById("hud")?.remove(),document.getElementById("virtual-dpad")?.remove(),document.getElementById("btn-action")?.remove(),document.getElementById("btn-jump")?.remove(),document.getElementById("interaction-indicator")?.classList.add("hidden"),document.getElementById("lite-mode-banner")?.remove();try{this.scene.isActive(v.UI)&&this.scene.stop(v.UI)}catch{}window.__worldExitFallback=setTimeout(()=>{window.__worldExitFallback=null;try{this.scene.isActive(v.WORLD)?this.scene.start(v.MAIN_MENU):this.scene.isActive(v.MAIN_MENU)||this.scene.start(v.MAIN_MENU)}catch(e){console.warn("[World] exit failed, reload",e),window.location.reload()}},120)}}_openModal(e){if(e.type===E.EXIT){this._exitToMenu();return}this._modalOpen=!0,this.scene.pause();let t;switch(e.type){case E.PROJECT:t=new W(e.data);break;case E.SKILLS:t=new X(e.data);break;case E.ABOUT:t=new Z(e.data);break;case E.CONTACT:t=new G(e.data);break;default:this._modalOpen=!1,this.scene.resume();return}t.open(()=>this._closeModal()),this._activeModal=t,w.playSFX(this,"sfx_open",{volume:.6})}_closeModal(){this._modalOpen&&(this._modalOpen=!1,this._activeModal?.close(),this._activeModal=null,w.playSFX(this,"sfx_close",{volume:.5}),this.scene.resume())}_checkDeviceCapability(){if(!((navigator.hardwareConcurrency||4)<4||window.innerWidth<480||/Android.*Chrome\/[.0-9]*\s/.test(navigator.userAgent)))return;const s=document.createElement("div");s.id="lite-mode-banner",s.innerHTML=`
      <div style="
    ...
    `,document.body.appendChild(s)}}export{te as default};
