import{P as d}from"./phaser-DGZayPUC.js";import{SCENE_KEYS as r}from"./gameConfig-D5w6vaLC.js";class h extends d.Scene{constructor(){super({key:r.UI}),this._indicatorEl=null,this._hudEl=null,this._currentObj=null}create(){this._indicatorEl=document.getElementById("interaction-indicator"),this._buildHUD(),this.events.once("shutdown",()=>{this._hudEl?.remove(),this._hudEl=null,this.hideIndicator(),this.input.keyboard.off("keydown-ESC")}),this.events.once("destroy",()=>{this._hudEl?.remove(),this.hideIndicator()})}_buildHUD(){this._hudEl&&this._hudEl.remove();const e=this.registry.get("playerName")||"Guest",t=document.createElement("div");t.id="hud",t.style.cssText="position:fixed;top:10px;left:10px;right:10px;display:flex;justify-content:space-between;align-items:center;z-index:90;pointer-events:none;",t.innerHTML=`
